...
INSERT INTO `clientes` VALUES (1,'00001','WILLIAN','JOAÇABA','SC'),(2,'00002','JOÃO','PORTO ALEGRE','RS'),(3,'00003','MARIA','LUZERNA','SC'),(4,'00004','LUCAS','VARGEM BONITA','SC'),(5,'00005','EMANUEL','VIDEIRA','SC'),(6,'00006','ARTHUR','PELOTAS','RS'),(7,'00007','ARNALDO','CURITIBA','PR'),(8,'00008','LEANDRO','BONITO','MG'),(9,'00009','ROSANA','CAMPO GRANDE','SP'),(10,'00010','GRAZIELE','CANOAS','RS'),(11,'00011','FLÁVIO','BALNEÁRIO CAMBORIU','SC'),(12,'00012','ALANA','PALMAS','TO'),(13,'00013','WESLEY','PALHOÇA','SC'),(14,'00014','PEDRO','TUBARÃO','SC'),(15,'00015','ANDRESSA','VILA VELHA','ES'),(16,'00016','YURI','VITÓRIA','ES'),(17,'00017','JULIANA','SANTA MARIA','RS'),(18,'00018','GABRIEL','SALVADOR','BA'),(19,'00019','ELDER','ITAPECERICA DA SERRA','SP'),(20,'00020','MARCELO','PORTO SEGURO','BA');
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `itenspedprod`
--

DROP TABLE IF EXISTS `itenspedprod`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `itenspedprod` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `NUMEROPEDIDO` varchar(5) DEFAULT NULL,
  `CODIGOPRODUTO` varchar(5) DEFAULT NULL,
  `QTDE` int DEFAULT NULL,
  `VLRUNITARIO` float DEFAULT NULL,
  `VALORTOTAL` float DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Itens da tabela pedido (produtos)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `itenspedprod`
--

LOCK TABLES `itenspedprod` WRITE;
/*!40000 ALTER TABLE `itenspedprod` DISABLE KEYS */;
/*!40000 ALTER TABLE `itenspedprod` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `produtos` VALUES (1,'00001','TECLADO',199.99),(2,'00002','MOUSE',259.8),(3,'00003','MOUSEPAD',86.5),(4,'00004','MONITOR SANSUNG',1288.99),(5,'00005','SOUND BAR',1655),(6,'00006','WEBCAM LOGITECH',448.6),(7,'00007','GABINETE THERMALTAKE',559.8),(8,'00008','PLACA DE VÍDEO RX580',640),(9,'00009','WATER COOOLER THERMALTAKE',300.8),(10,'00010','MEMÓRIA RAM 8GB',468.8),(11,'00011','FONTE THERMALTAKE 600W',199.99),(12,'00012','MOUSE HYPERX 5000DPI',259.8),(13,'00013','PROCESSADOR I7 7700',989.8),(14,'00014','ROTEADOR TP LINK',159.8),(15,'00015','CABO DE FORÇA',39.9),(16,'00016','TV LG, SMART, 42 PLEGADAS',1059.8),(17,'00017','AR CONDICIONADO SANSUNG 9000 BTU',1650.8),(18,'00018','CAIXA DE SOM JBL FLIP 3',287.55),(19,'00019','CADEIRA GAMER FORTREK',985.8),(20,'00020','MESA ESCRITÓRIO',578.99);
...
-- Dump completed on 2024-06-03  5:50:23
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-05-31 17:29:01',NULL),('diagnostics.include_raw','OFF','2024-05-31 17:29:01',NULL),('ps_thread_trx_info.max_length','65535','2024-05-31 17:29:01',NULL),('statement_performance_analyzer.limit','100','2024-05-31 17:29:01',NULL),('statement_performance_analyzer.view',NULL,'2024-05-31 17:29:01',NULL),('statement_truncate_len','64','2024-05-31 17:29:01',NULL);
...
-- Dump completed on 2024-06-03  5:50:25
